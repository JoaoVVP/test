...
RandomAccess {
    ...
    @Override
    public ObjectListIterator<int[]> listIterator(final int start2) {
        ...
        return new ObjectListIterator<int[]>(){
            ...
            {
                if (start2 != 0) {
                    if (start2 == IntArrayFrontCodedList.this.n) {
                        this.i = start2;
                    } else {
                        this.pos = IntArrayFrontCodedList.this.p[start2 / IntArrayFrontCodedList.this.ratio];
                        int j = start2 % IntArrayFrontCodedList.this.ratio;
                        this.i = start2 - j;
                        while (j-- != 0) {
                            this.next();
                        }
