...
RandomAccess {
    ...
    @Override
    public ObjectListIterator<char[]> listIterator(final int start2) {
        ...
        return new ObjectListIterator<char[]>(){
            ...
            {
                if (start2 != 0) {
                    if (start2 == CharArrayFrontCodedList.this.n) {
                        this.i = start2;
                    } else {
                        this.pos = CharArrayFrontCodedList.this.p[start2 / CharArrayFrontCodedList.this.ratio];
                        int j = start2 % CharArrayFrontCodedList.this.ratio;
                        this.i = start2 - j;
                        while (j-- != 0) {
                            this.next();
                        }
