...
RandomAccess {
    ...
    @Override
    public ObjectListIterator<byte[]> listIterator(final int start2) {
        ...
        return new ObjectListIterator<byte[]>(){
            ...
            {
                if (start2 != 0) {
                    if (start2 == ByteArrayFrontCodedList.this.n) {
                        this.i = start2;
                    } else {
                        this.pos = ByteArrayFrontCodedList.this.p[start2 / ByteArrayFrontCodedList.this.ratio];
                        int j = start2 % ByteArrayFrontCodedList.this.ratio;
                        this.i = start2 - j;
                        while (j-- != 0) {
                            this.next();
                        }
