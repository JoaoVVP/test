...
RandomAccess {
    ...
    @Override
    public ObjectListIterator<long[]> listIterator(final int start2) {
        ...
        return new ObjectListIterator<long[]>(){
            ...
            {
                if (start2 != 0) {
                    if (start2 == LongArrayFrontCodedList.this.n) {
                        this.i = start2;
                    } else {
                        this.pos = LongArrayFrontCodedList.this.p[start2 / LongArrayFrontCodedList.this.ratio];
                        int j = start2 % LongArrayFrontCodedList.this.ratio;
                        this.i = start2 - j;
                        while (j-- != 0) {
                            this.next();
                        }
