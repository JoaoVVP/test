...
import com.jelly.mightyminerv2.deps.it.unimi.dsi.fastutil.objects.AbstractObjectList;
...
RandomAccess {
    ...
    @Override
    public ObjectListIterator<short[]> listIterator(final int start2) {
        this.ensureIndex(start2);
        return new ObjectListIterator<short[]>(){
            ...
            {
                if (start2 != 0) {
                    if (start2 == ShortArrayFrontCodedList.this.n) {
                        this.i = start2;
                    } else {
                        this.pos = ShortArrayFrontCodedList.this.p[start2 / ShortArrayFrontCodedList.this.ratio];
                        int j = start2 % ShortArrayFrontCodedList.this.ratio;
                        this.i = start2 - j;
                        while (j-- != 0) {
                            this.next();
                        }
